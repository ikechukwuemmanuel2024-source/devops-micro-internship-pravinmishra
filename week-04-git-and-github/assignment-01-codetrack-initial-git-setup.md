...
![Screenshot 0](screenshots/week-04-00.png) 

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![Screenshot 1](screenshots/week-04-01.png) 
...
The .git folder is a hidden directory that Git creates when a repository is initialized. It stores the repository's version history, configuration, branches, commits, and other metadata. It matters because it enables Git to track changes, manage different versions of the project, and support collaboration without affecting the project files themselves.
...
![Screenshot 2](screenshots/week-04-02.png)
...
![Screenshot 3](screenshots/week-04-03.png)
